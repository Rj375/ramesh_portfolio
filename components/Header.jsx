  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      >
        ...
        <Image src={assets.user_image1} alt='profile image' className='rounded-full w-28 mt-28'/>
      </motion.div>
      <motion.h3 
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Ramesh Giri<Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
    <motion.h1 
    ...
    className='text-3xl sm:text-6xl lg:text-[60px] font-Ovo'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="/Ramesh_Giri_IT_Resume.pdf" download 
